...
public class monster_crow : MonoBehaviour
{
    ...
    IEnumerator CrowMove()
    {
        ...
        int death = Random.Range(4,16+(factory.hamsterAmountTotal[factory.targetField]/5));
